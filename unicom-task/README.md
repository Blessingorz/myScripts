...
```
export unicom_config_1="手机号1<<<服务密码1<<<appId1<<<抽奖次数(0-30)中奖几率渺茫（可留空）<<<沃邮箱登陆Url1（可留空）<<<沃邮箱密码（可留空）"
export unicom_config_2="手机号2<<<服务密码2<<<appId2<<<抽奖次数(0-30)中奖几率渺茫（可留空）<<<沃邮箱登陆Url2（可留空）<<<沃邮箱密码（可留空）"  
...
value填     手机号1<<<服务密码1<<<appId1<<<抽奖次数(0-30)中奖几率渺茫（可留空）<<<沃邮箱登陆Url1（可留空）<<<沃邮箱密码（可留空）           
```
